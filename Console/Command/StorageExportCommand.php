...
class StorageExportCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        return $this->state->emulateAreaCode(Area::AREA_ADMINHTML, function () use ($output) {
            ...
            if ($this->coreFileStorage->getCurrentStorageCode() === \Simone\S3\Model\MediaStorage\File\Storage::STORAGE_MEDIA_S3) {
            ...
            /** @var \Simone\S3\Model\MediaStorage\File\Storage\S3 $destinationModel */
            $destinationModel = $this->coreFileStorage->getStorageModel(\Simone\S3\Model\MediaStorage\File\Storage::STORAGE_MEDIA_S3);
