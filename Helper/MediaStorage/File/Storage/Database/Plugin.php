<?php
namespace Simone\S3\Helper\MediaStorage\File\Storage\Database;
...
use Simone\S3\Model\MediaStorage\File\Storage\S3Factory;
...
class Plugin
{
    ...
    {
        if ($this->helper->checkS3Usage()) {
            /** @var \Simone\S3\Model\MediaStorage\File\Storage\S3 $storageModel */
