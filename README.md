AWS S3 Extension for Magento 2
=================================
...
Simone's S3 extension for Magento 2 allows retailers to upload their catalogue and WYSIWYG images straight to Amazon S3.
...
See the [Installation](https://github.com/scgoeswild/Magento2-aws-s3/wiki/Installation) page on the wiki.

Support
-------

Feel free to [create a GitHub issue](https://github.com/scgoeswild/Magento2-aws-s3/issues/new) for support regarding this extension.
...
Are you a happy user of my extension? I would love to feature you! [Create a GitHub issue](https://github.com/scgoeswild/Magento2-aws-s3/issues/new) or [send me an email](mailto:hello@simonechinaglia.net) to discuss opportunities for cross promotion!
